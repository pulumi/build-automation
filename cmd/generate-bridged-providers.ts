...
import { providersDir, getConfig } from "../src/config";
import { ProviderFile } from "../src/workflows/provider";
import { buildProviderFiles } from "../src/workflows/provider";
import { generateProviderFiles } from "../src/workflows/provider/bridged";
...
const writeProviderFiles = (provider: Provider) => {
  ...
  for (const file of provider.files) {
    ...
    const generatedHeader =
      ...
      "will be overwritten if not made via https://github.com/pulumi/[ci-mgmt|build-automation]\n\n";
